...
PROCTHOR_COMMIT_ID = '6c0aafb84ca6ffe902768411a7b7b0c895de40be'
stretch_1_adr = '172.16.3.48'
REAL_STRETCH_SERVER = stretch_1_adr
...
INTEL_REAL_W, INTEL_REAL_H = 720, 1280
INTEL_RESIZED_W, INTEL_RESIZED_H = 180, 320
INTEL_FOV_W, INTEL_FOV_H = 69, 42

MIN_HORIZON, MAX_HORIZON = 0, 60

# MIN_INTEL_DEPTH = 0.28
MIN_INTEL_DEPTH = 0
MAX_INTEL_DEPTH = 7 #TODO I think this is safe to do
