...
from manipulathor_baselines.procthor_baselines.experiments.objectnav.only_explore_for_single_robothor_room_rgb_only import \
    OnlyExploreSingleRealRoboTHORRoomsRGBOnly


class OnlyExploreSingleRealRoboTHORRoomsRGBOnlyDistrib(
    OnlyExploreSingleRealRoboTHORRoomsRGBOnly
):
