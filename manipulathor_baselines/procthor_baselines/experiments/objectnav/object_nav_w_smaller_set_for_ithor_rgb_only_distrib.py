...
from manipulathor_baselines.procthor_baselines.experiments.objectnav.object_nav_w_smaller_set_for_ithor_rgb_only import \
    ObjNavSmallSetITHORAllRoomsRGBOnly


class ObjNavSmallSetITHORAllRoomsRGBOnlyDistrib(
    ObjNavSmallSetITHORAllRoomsRGBOnly
):
