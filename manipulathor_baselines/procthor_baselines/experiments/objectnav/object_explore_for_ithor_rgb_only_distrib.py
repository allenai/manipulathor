...
from manipulathor_baselines.procthor_baselines.experiments.objectnav.object_explore_for_ithor_rgb_only import \
    ObjExploreITHORAllRoomsRGBOnly


class ObjExploreITHORAllRoomsRGBOnlyDistrib(
    ObjExploreITHORAllRoomsRGBOnly
):
