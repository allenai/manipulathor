...
from manipulathor_baselines.procthor_baselines.experiments.objectnav.only_explore_for_all_robothor_room_rgb_only import \
    OnlyExploreAllRoboTHORRoomsRGBOnly


class OnlyExploreAllRoboTHORRoomsRGBOnlyDistrib(
    OnlyExploreAllRoboTHORRoomsRGBOnly
):
