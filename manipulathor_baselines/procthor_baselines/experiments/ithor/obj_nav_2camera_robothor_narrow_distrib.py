...
from manipulathor_baselines.procthor_baselines.experiments.ithor.obj_nav_2camera_robothor_narrow import \
    RobothorObjectNavClipResnet50RGBOnly2CameraNarrowFOV


class RobothorObjectNavClipResnet50RGBOnly2CameraNarrowFOVDistrib(
    RobothorObjectNavClipResnet50RGBOnly2CameraNarrowFOV
):
