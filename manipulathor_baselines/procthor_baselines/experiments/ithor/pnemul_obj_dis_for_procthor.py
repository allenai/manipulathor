...
class PNEmulObjDisArmPointNavProcTHORAllRooms(
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PNEmulObjDisArmPointNavProcTHORAllRooms, self).test_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PNEmulObjDisArmPointNavProcTHORAllRooms, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
