...
from manipulathor_baselines.procthor_baselines.experiments.ithor.clip_obj_dis_for_procthor_rgb_only_multiple_rooms import \
    CLIPObjDisArmPointNavProcTHORAllRoomsRGBOnlyMultipleRooms


class CLIPObjDisArmPointNavProcTHORAllRoomsRGBOnlyMultipleRoomsDistrib(
    CLIPObjDisArmPointNavProcTHORAllRoomsRGBOnlyMultipleRooms
):
