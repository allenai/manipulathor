...
from manipulathor_baselines.procthor_baselines.models.objdis_pointnav_only_depth_model import \
    ObjDisPointNavOnlyDepthModel
...
class ObjDisArmPointNavProcTHOROnlyDepth(
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return ObjDisPointNavOnlyDepthModel(
