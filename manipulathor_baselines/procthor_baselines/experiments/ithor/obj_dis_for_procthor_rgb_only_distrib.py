...
from manipulathor_baselines.procthor_baselines.experiments.ithor.obj_dis_for_procthor_rgb_only import \
    ObjDisArmPointNavRGBOnlyProcTHOR


class ObjDisArmPointNavRGBOnlyProcTHORDistrib(
    ObjDisArmPointNavRGBOnlyProcTHOR
):
