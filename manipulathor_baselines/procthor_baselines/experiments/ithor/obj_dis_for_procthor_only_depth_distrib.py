...
from manipulathor_baselines.procthor_baselines.experiments.ithor.obj_dis_for_procthor_only_depth import \
    ObjDisArmPointNavProcTHOROnlyDepth


class ObjDisArmPointNavProcTHOROnlyDepthDistrib(
    ObjDisArmPointNavProcTHOROnlyDepth
):
