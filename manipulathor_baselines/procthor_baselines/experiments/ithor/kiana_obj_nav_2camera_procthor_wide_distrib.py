...
from manipulathor_baselines.procthor_baselines.experiments.ithor.kiana_obj_nav_2camera_procthor_wide import \
    KianaProcTHORObjectNavClipResnet50RGBOnly2CameraWideFOV


class KianaProcTHORObjectNavClipResnet50RGBOnly2CameraWideFOVDistrib(
    KianaProcTHORObjectNavClipResnet50RGBOnly2CameraWideFOV
):
