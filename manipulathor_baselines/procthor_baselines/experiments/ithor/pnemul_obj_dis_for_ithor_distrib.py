...
from manipulathor_baselines.procthor_baselines.experiments.ithor.pnemul_obj_dis_for_ithor import \
    PNEmulObjDisArmPointNavITHORAllRooms


class PNEmulObjDisArmPointNavITHORAllRoomsDistrib(
    PNEmulObjDisArmPointNavITHORAllRooms
):
