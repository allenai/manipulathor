...
from manipulathor_baselines.procthor_baselines.experiments.ithor.obj_nav_2camera_procthor_narrow import \
    ProcTHORObjectNavClipResnet50RGBOnly2CameraNarrowFOV


class ProcTHORObjectNavClipResnet50RGBOnly2CameraNarrowFOVDistrib(
    ProcTHORObjectNavClipResnet50RGBOnly2CameraNarrowFOV
):
