...
from scripts.dataset_generation.find_categories_to_use import ROBOTHOR_OBJECTNAV_OBJECTS, ROBOTHOR_TRAIN, ROBOTHOR_VAL, \
    BEDROOM_TRAIN, KITCHEN_TRAIN, BATHROOM_TRAIN, LIVING_ROOM_TRAIN, BEDROOM_TEST, BATHROOM_TEST, KITCHEN_TEST, LIVING_ROOM_TEST
...
class TmpiTHORObjectNavClipResnet50RGBOnly2CameraWideFOV(
    ...
    OBJECT_TYPES = OBJECT_TYPES_Habitat_Robothor#[o for o in OBJECT_TYPES_Habitat_Robothor if o in ROBOTHOR_OBJECTNAV_OBJECTS]
    MAX_STEPS = 500
    ...
    TRAIN_SCENES = BEDROOM_TRAIN + BATHROOM_TRAIN + KITCHEN_TRAIN + LIVING_ROOM_TRAIN
    TEST_SCENES = BEDROOM_TEST + BATHROOM_TEST + KITCHEN_TEST + LIVING_ROOM_TEST
