...
class ObjDisPointNavOnlyDepthModel(ActorCriticModel[CategoricalDistr]):
    ...
    def __init__(
        ...
        network_args = {'input_channels': 1, 'layer_channels': [32, 64, 32], 'kernel_sizes': [(8, 8), (4, 4), (3, 3)], 'strides': [(4, 4), (2, 2), (1, 1)], 'paddings': [(0, 0), (0, 0), (0, 0)], 'dilations': [(1, 1), (1, 1), (1, 1)], 'output_height': 24, 'output_width': 24, 'output_channels': 512, 'flatten': True, 'output_relu': True}
    ...
    def forward(  # type:ignore
        ...
        if self.visualize:
            ...
            hacky_visualization(observations, object_mask=observations['depth_lowres'], base_directory_to_right_images=self.starting_time, distance_vector_to_viz=distance_vector_to_viz)
