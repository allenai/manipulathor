...
class SimpleConvObjectNavStretch(ActorCriticModel[CategoricalDistr]):
    ...
    def __init__(
        ...
        self.actor = LinearActorHeadNoCategory(self._hidden_size, action_space.n)
    ...
    def forward(  # type:ignore
        ...
        visual_observation_arm = observations['rgb_lowres_arm']
        ...
        visual_observation_encoding = torch.cat([visual_observation_encoding_body, visual_observation_encoding_arm, target_object_embedding], dim=-1)
        ...
        actor_out_final = actor_out
        critic_out_final = critic_out
