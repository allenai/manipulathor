...
from manipulathor_baselines.bring_object_baselines.experiments.ithor.zero_shot_complex_reward_no_pu_w_agent_location import ComplexRewardNoPUwAgentLocationZeroShot


class ComplexRewardNoPUwAgentLocationZeroShotDistrib(
    ComplexRewardNoPUwAgentLocationZeroShot
):
    NUM_PROCESSES = 20
    def __init__(
            self,
