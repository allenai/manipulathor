...
class SmartPointNavNewModelAndHandWAgentNoise(
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(SmartPointNavNewModelAndHandWAgentNoise, self).train_task_sampler_args(**kwargs)
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(SmartPointNavNewModelAndHandWAgentNoise, self).test_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
