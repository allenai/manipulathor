...
from ithor_arm.pointcloud_sensors import KianaReachableBoundsTHORSensor, KianaBinnedPointCloudMapTHORSensor
...
from manipulathor_baselines.bring_object_baselines.models.temp_viz_pc_query_obj_w_gt_mask_rgb_model import TempVizPCSmallBringObjectWQueryObjGtMaskRGBDModel
...
class ComplexRewardNoPUBinaryDistance(
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return TempVizPCSmallBringObjectWQueryObjGtMaskRGBDModel(
