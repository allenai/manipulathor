...
from ithor_arm.bring_object_task_samplers import DiverseBringObjectTaskSamplerReplay
from ithor_arm.bring_object_tasks import WPickUPExploreBringObjectTask, ExploreWiseRewardTask, \
    ExploreWiseRewardTaskReplay
...
from manipulathor_baselines.bring_object_baselines.models.replay_predict_super_simple_pointnav_emulator_model import \
    PredictSuperSimpleRGBDModelWPointNavEmulatorReplay
...
class PredictionPointNavNoPUNewModelAndHand(
    ...
    TASK_SAMPLER = DiverseBringObjectTaskSamplerReplay
    # TASK_TYPE = TestPointNavExploreWiseRewardTask
    TASK_TYPE = ExploreWiseRewardTaskReplay
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return PredictSuperSimpleRGBDModelWPointNavEmulatorReplay(
