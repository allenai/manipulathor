...
from ithor_arm.bring_object_sensors import CategorySampleSensor, NoisyObjectMask, NoGripperRGBSensorThor, CategoryFeatureSampleSensor, NoMaskSensor
...
class ComplexRewardNoPUNoMask(
    ...
    # TEST_SCENES = BringObjectiThorBaseConfig.TRAIN_SCENES # are we sure?
