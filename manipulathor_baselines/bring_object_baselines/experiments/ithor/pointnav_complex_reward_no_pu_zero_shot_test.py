...
class PointNavNewModelAndHandZeroShotTest(
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavNewModelAndHandZeroShotTest, self).train_task_sampler_args(**kwargs)
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavNewModelAndHandZeroShotTest, self).test_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
