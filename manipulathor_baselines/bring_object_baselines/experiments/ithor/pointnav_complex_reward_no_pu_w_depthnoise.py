...
from ithor_arm.near_deadline_sensors import PointNavEmulatorSensor, NoisyDepthSensorThor
...
class PointNavNewModelAndHandWDepthNoise(
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavNewModelAndHandWDepthNoise, self).train_task_sampler_args(**kwargs)
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavNewModelAndHandWDepthNoise, self).test_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
