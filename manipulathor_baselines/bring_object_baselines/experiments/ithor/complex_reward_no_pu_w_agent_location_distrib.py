...
from manipulathor_baselines.bring_object_baselines.experiments.ithor.complex_reward_no_pu_w_agent_location import ComplexRewardNoPUwAgentLocation


class ComplexRewardNoPUwAgentLocationDistrib(
    ComplexRewardNoPUwAgentLocation
):
    NUM_PROCESSES = 30
    def __init__(
            self,
