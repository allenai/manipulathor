...
from ithor_arm.near_deadline_sensors import PointNavEmulatorSensor, SmarterPointNavEmulatorSensor
...
class PointNavNewModelAndHandWAgentNoiseMorePrecise(
    ...
    SENSORS = [
        ...
        SmarterPointNavEmulatorSensor(source_mask_sensor=source_mask_sensor, destination_mask_sensor=destination_mask_sensor, noise=AGENT_LOCATION_NOISE),
