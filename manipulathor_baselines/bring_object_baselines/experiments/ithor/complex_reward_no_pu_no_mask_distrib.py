...
import gym
import torch
from manipulathor_baselines.bring_object_baselines.experiments.ithor.complex_reward_no_pu_no_mask import ComplexRewardNoPUNoMask



class ComplexRewardNoPUNoMaskDistrib(
    ComplexRewardNoPUNoMask
):
    NUM_PROCESSES = 30
    def __init__(
            self,
