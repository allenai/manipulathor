...
import gym
import torch
from manipulathor_baselines.bring_object_baselines.experiments.ithor.complex_reward_no_pu_w_real_pointnav import ComplexRewardNoPUWRealPointNav


class ComplexRewardNoPUWRealPointNavDistrib(
    ComplexRewardNoPUWRealPointNav
):
    def __init__(
            self,
