...
from ithor_arm.bring_object_sensors import TargetObjectBBox, TargetLocationBBox, NoisyTargetObjectBBox, NoisyTargetLocationBBox
...
class NoisyBBoxSimpleDiverseBringObject(
    ...
    SENSORS = [
        ...
        PickedUpObjSensor(),
        NoisyTargetObjectBBox(),
        NoisyTargetLocationBBox(),
    ]
