...
from ithor_arm.near_deadline_sensors import PredictionObjectMask, AgentRelativeLocationSensor, NoisyDepthSensorThor
...
class PredictMaskNoNoiseRGBQueryObjGTMaskSimpleDiverseBringObjectWDepthNoise(
