...
from manipulathor_baselines.bring_object_baselines.experiments.ithor.complex_reward_no_pu_w_pc import ComplexRewardNoPUWPointCloudMemory
...
class ComplexRewardNoPUWPointCloudMemoryDistrib(
    ComplexRewardNoPUWPointCloudMemory
):
    def __init__(
            self,
