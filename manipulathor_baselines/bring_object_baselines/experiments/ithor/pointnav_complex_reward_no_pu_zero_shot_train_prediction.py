...
class PredictPointNavEmulZeroShotTrain(
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PredictPointNavEmulZeroShotTrain, self).test_task_sampler_args(**kwargs)
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PredictPointNavEmulZeroShotTrain, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
