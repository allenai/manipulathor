...
from manipulathor_baselines.bring_object_baselines.experiments.ithor.pointnav_complex_reward_no_pu_zero_shot import PointNavNewModelAndHandZeroShot


class PointNavNewModelAndHandZeroShotDistrib(
    PointNavNewModelAndHandZeroShot
):
    NUM_PROCESSES = 20
    def __init__(
            self,
