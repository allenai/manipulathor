...
from ithor_arm.near_deadline_sensors import PredictionObjectMask, AgentRelativeLocationSensor
...
from manipulathor_baselines.bring_object_baselines.models.predict_simple_model_no_pu_w_agent_location import PredictSimpleWAgentLocation


class ZeroShotTrainPredictMaskNoNoiseRGBQueryObjGTMaskSimpleDiverseBringObject(
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(ZeroShotTrainPredictMaskNoNoiseRGBQueryObjGTMaskSimpleDiverseBringObject, self).test_task_sampler_args(**kwargs)
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(ZeroShotTrainPredictMaskNoNoiseRGBQueryObjGTMaskSimpleDiverseBringObject, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
