...
from manipulathor_baselines.bring_object_baselines.experiments.ithor.pointnav_only_agent_loc_complex_reward_no_pu import PointNavOnlyAgentLoc


class PointNavOnlyAgentLocDistrib(
    PointNavOnlyAgentLoc
):
    NUM_PROCESSES = 20
    def __init__(
            self,
