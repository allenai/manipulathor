...
class PredictionPointNavNoPUNewModelAndHand(
    ...
    SENSORS = [
        ...
        PointNavEmulatorSensor(type='source', mask_sensor=source_mask_sensor_prediction, noise=AGENT_LOCATION_NOISE),
        PointNavEmulatorSensor(type='destination', mask_sensor=destination_mask_sensor_prediction, noise=AGENT_LOCATION_NOISE),
    ]
