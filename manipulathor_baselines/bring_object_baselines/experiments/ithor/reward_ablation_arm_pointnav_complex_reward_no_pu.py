...
class PointNavNewModelAndHandAblationArmAblationExplore(
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavNewModelAndHandAblationArmAblationExplore, self).train_task_sampler_args(**kwargs)
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavNewModelAndHandAblationArmAblationExplore, self).test_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
    ...
    def __init__(self):
        ...
        self.REWARD_CONFIG['arm_dist_multiplier'] = 0
