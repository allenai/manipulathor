...
from manipulathor_baselines.bring_object_baselines.models.big_query_obj_w_gt_mask_rgb_model import BigBringObjectWQueryObjGtMaskRGBDModel
...
class QueryObjGTMaskSimpleDiverseBringObject(
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return BigBringObjectWQueryObjGtMaskRGBDModel(
