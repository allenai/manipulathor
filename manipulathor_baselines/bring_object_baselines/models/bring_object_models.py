...
class BringObjectBaselineActorCritic(ActorCriticModel[CategoricalDistr]):
    ...
    def forward(  # type:ignore
        ...
        #TODO maybe we really need to switch to resnet now that visual features are actually important

        #TODO use object type as input

        #TODO check object nav to see what they do
