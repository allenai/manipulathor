...
class PredictBBoxwTFBringObjectModel(ActorCriticModel[CategoricalDistr]):
    ...
    def __init__(
        ...
        encoder_decoder_args = {'input_channels': 3, 'layer_channels': [32, 64, 32], 'kernel_sizes': [(8, 8), (4, 4), (3, 3)], 'strides': [(4, 4), (2, 2), (1, 1)], 'paddings': [(0, 0), (0, 0), (0, 0)], 'dilations': [(1, 1), (1, 1), (1, 1)], 'output_height': 24, 'output_width': 24, 'output_channels': 512, 'flatten': True, 'output_relu': True}
        self.mask_predictor = make_encoder_decoder(**encoder_decoder_args)
