...
class PredictSuperSimpleRGBDModelWPointNavEmulatorReplay(ActorCriticModel[CategoricalDistr]):
    ...
    def forward(  # type:ignore
        ...
        x_out = torch.zeros((1,1,512)).float().to(observations["pickedup_object"].device) #TODO?
