...
class PickUpObjectBaselineActorCritic(ActorCriticModel[CategoricalDistr]):
    ...
    def __init__(
        ...
        """
        raise Exception('Deprecated, check todos, write new models')
        ...
        self.visual_encoder_nav_camera = SimpleCNN(
            self.observation_space,
            self._hidden_size,
            rgb_uuid="rgb_lowres" if "rgb_lowres" in sensor_names else None,
            depth_uuid=None,
        )
        self.visual_encoder_manip_camera = SimpleCNN(
            self.observation_space,
            self._hidden_size,
            rgb_uuid="rgb_lowres" if "rgb_lowres" in sensor_names else None,
            depth_uuid= None,
