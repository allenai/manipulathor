...
class PointNavEmulStretch(
    ...
    SENSORS = [
        ...
        # PointNavEmulSensor(type='destination', uuid='arm_point_nav'),

    ]

    #TODO later add the segmentation mask as input to the model as well?

    MAX_STEPS = 200

    TASK_SAMPLER = StretchDiverseBringObjectTaskSampler
    # TASK_TYPE = StretchExploreWiseRewardTaskOnlyPickUp #TODO put back
