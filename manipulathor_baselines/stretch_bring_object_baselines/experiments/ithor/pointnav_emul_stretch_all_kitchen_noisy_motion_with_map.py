...
class PointNavEmulStretchAllKitchensWithMap(
    StretchBringObjectiThorBaseConfig,
    StretchBringObjectMixInPPOConfig,
    StretchBringObjectMixInSimpleGRUConfig,
):
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllKitchensWithMap, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
