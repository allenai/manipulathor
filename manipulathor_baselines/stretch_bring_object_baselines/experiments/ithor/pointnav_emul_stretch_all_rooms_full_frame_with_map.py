...
class PointNavEmulStretchAllRoomsFullFrameWithMap(
    StretchBringObjectiThorBaseConfig,
    StretchBringObjectMixInPPOConfig,
    StretchBringObjectMixInSimpleGRUConfig,
):
    ...
    def __init__(self):
        ...
        self.ENV_ARGS['motion_noise_args']['effect_scale'] = 0.0

    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllRoomsFullFrameWithMap, self).test_task_sampler_args(**kwargs)
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllRoomsFullFrameWithMap, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
