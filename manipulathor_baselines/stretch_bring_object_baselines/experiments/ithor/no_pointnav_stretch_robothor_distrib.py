...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.no_pointnav_stretch_robothor import \
    NoPointNavStretchRoboTHOR


class NoPointNavStretchRoboTHORDistrib(
    NoPointNavStretchRoboTHOR
):
    NUM_PROCESSES = 25
    def __init__(
