...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.no_pointnav_stretch_all_rooms import \
    NoPointNavStretchAllRooms


class NoPointNavStretchAllRoomsDistrib(
    NoPointNavStretchAllRooms
):
    NUM_PROCESSES = 25
    def __init__(
