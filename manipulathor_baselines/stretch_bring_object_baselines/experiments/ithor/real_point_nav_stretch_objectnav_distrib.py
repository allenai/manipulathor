...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.real_point_nav_stretch_objectnav import RealPointNavStretchObjectNav


class RealPointNavStretchObjectNavDistrib(
    RealPointNavStretchObjectNav
):
    NUM_PROCESSES = 30
    def __init__(
            self,
