...
class PointNavEmulStretchAllRoomsNoisyMotionWithISDF(
    StretchBringObjectiThorBaseConfig,
    StretchBringObjectMixInPPOConfig,
    StretchBringObjectMixInSimpleGRUConfig,
):
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllRoomsNoisyMotionWithISDF, self).test_task_sampler_args(**kwargs)
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllRoomsNoisyMotionWithISDF, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
