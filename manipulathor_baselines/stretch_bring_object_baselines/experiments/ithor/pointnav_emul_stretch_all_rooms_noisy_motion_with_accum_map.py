...
class PointNavEmulStretchAllRoomsNoisyMotionWithAccumMap(
    StretchBringObjectiThorBaseConfig,
    StretchBringObjectMixInPPOConfig,
    StretchBringObjectMixInSimpleGRUConfig,
):
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllRoomsNoisyMotionWithAccumMap, self).test_task_sampler_args(**kwargs)
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllRoomsNoisyMotionWithAccumMap, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return StretchObjectDisplacementMapModel(
            ...
            accumulate_maps_across_visits=True,
        )
