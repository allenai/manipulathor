...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_all_rooms_noisy_motion_gt_pose_rel \
    import PointNavEmulStretchAllRoomsNoisyMotionGTPoseRelative


class PointNavEmulStretchAllRoomsNoisyMotionGTPoseRelativeDistrib(
    PointNavEmulStretchAllRoomsNoisyMotionGTPoseRelative
):
    NUM_PROCESSES = 8
    def __init__(
            self,
