...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_all_rooms_noisy_motion_with_accum_map \
    import PointNavEmulStretchAllRoomsNoisyMotionWithAccumMap


class PointNavEmulStretchAllRoomsNoisyMotionWithAccumMapDistrib(
    PointNavEmulStretchAllRoomsNoisyMotionWithAccumMap
):
    NUM_PROCESSES = 8
    def __init__(
            self,
