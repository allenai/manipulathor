...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_all_rooms_no_noise_with_map \
    import PointNavEmulStretchAllRoomsNoNoiseWithMap


class PointNavEmulStretchAllRoomsNoNoiseWithMapDistrib(
    PointNavEmulStretchAllRoomsNoNoiseWithMap
):
    NUM_PROCESSES = 8
    def __init__(
            self,
