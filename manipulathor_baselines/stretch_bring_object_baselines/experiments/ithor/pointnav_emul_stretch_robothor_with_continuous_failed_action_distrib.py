...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_robothor_with_continuous_failed_action import \
    PointNavEmulStretchRoboTHORwRealisticFails


class PointNavEmulStretchRoboTHORwRealisticFailsDistrib(
    PointNavEmulStretchRoboTHORwRealisticFails
):
    NUM_PROCESSES = 20
    def __init__(
