...
from manipulathor_baselines.stretch_bring_object_baselines.models.stretch_object_displacement_isdf import StretchObjectDisplacementISDFModel
...
class PointNavEmulStretchAllRoomsNoisyMotionWithISDFPretrained(
    StretchBringObjectiThorBaseConfig,
    StretchBringObjectMixInPPOConfig,
    StretchBringObjectMixInSimpleGRUConfig,
):
    ...
    odometry_sensor = AgentOdometryEmulSensor(fixed_frame=True)
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllRoomsNoisyMotionWithISDFPretrained, self).test_task_sampler_args(**kwargs)
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllRoomsNoisyMotionWithISDFPretrained, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return StretchObjectDisplacementISDFModel(
