...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_all_rooms_no_noise \
    import PointNavEmulStretchAllRoomsNoNoise


class PointNavEmulStretchAllRoomsNoNoiseDistrib(
    PointNavEmulStretchAllRoomsNoNoise
):
    NUM_PROCESSES = 12
    def __init__(
            self,
