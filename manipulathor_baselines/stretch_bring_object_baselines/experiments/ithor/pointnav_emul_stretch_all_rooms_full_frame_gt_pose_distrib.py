...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_all_rooms_full_frame_gt_pose \
    import PointNavEmulStretchAllRoomsFullFrameGTPose


class PointNavEmulStretchAllRoomsFullFrameGTPoseDistrib(
    PointNavEmulStretchAllRoomsFullFrameGTPose
):
    NUM_PROCESSES = 8
    def __init__(
            self,
