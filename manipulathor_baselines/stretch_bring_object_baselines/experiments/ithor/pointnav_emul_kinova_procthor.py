...
class PointNavEmulKinovaProcTHOR(
    StretchBringObjectiThorBaseConfig,
    StretchBringObjectMixInPPOConfig,
    StretchBringObjectMixInSimpleGRUConfig,
):
    ...
    def __init__(self):
        ...
        self.ENV_ARGS = MANIPULATHOR_ENV_ARGS
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulKinovaProcTHOR, self).test_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulKinovaProcTHOR, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
