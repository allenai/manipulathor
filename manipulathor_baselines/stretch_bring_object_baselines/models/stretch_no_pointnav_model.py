...
class StretchNoPointNavModel(ActorCriticModel[CategoricalDistr]):
    ...
    def forward(  # type:ignore
        ...
        if self.visualize:
            ...
            hacky_visualization(observations, object_mask=intel_mask, gt_mask=kinect_mask, base_directory_to_right_images=self.starting_time)
