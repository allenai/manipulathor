...
from ithor_arm.exploration_task_samplers import ExploreTaskSampler
from ithor_arm.exploration_tasks import ExploreTask
...
from manipulathor_baselines.only_exploration.models.query_obj_w_gt_mask_rgb_model import ExplorationModel
...
class ComplexRewardNoPU(
    ...
    def __init__(self):
        ...
        self.REWARD_CONFIG['object_reward'] = 0.1 # is this too big?
