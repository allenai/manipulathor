...
from ithor_arm.bring_object_sensors import TargetObjectBBox, TargetLocationBBox, NoisyTargetObjectMask, NoisyTargetLocationMask
...
class NoisyMaskSimpleDiverseBringObject(
    ...
    SENSORS = [
        ...
        PickedUpObjSensor(),
        NoisyTargetObjectMask(),
        NoisyTargetLocationMask(),
    ]
