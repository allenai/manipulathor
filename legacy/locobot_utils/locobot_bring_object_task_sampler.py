...
from utils.locobot_utils.locobot_environment import LocoBotEnvironment
from utils.locobot_utils.locobot_tasks import LocoBotBringObjectTask


class LocoBotDiverseBringObjectTaskSampler(DiverseBringObjectTaskSampler):
    _TASK_TYPE = LocoBotBringObjectTask

    def _create_environment(self, **kwargs) -> ManipulaTHOREnvironment:
        env = LocoBotEnvironment(
