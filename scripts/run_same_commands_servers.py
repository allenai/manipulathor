...
--distributed_ip_and_port IP_ADR:6060 \
 --config_kwargs \'{\\"distributed_nodes\\":NUM_MACHINES}\' \
 --seed 10 --machine_id 0 --extra_tag train_object_nav_with_mask'# -c ~/exp_PointNavEmulStretchDistrib_train_object_nav_with_mask__stage_00__steps_000002540050.pt'
