...
SET_OF_ALL_AGENT_ACTIONS = [MOVE_AHEAD, MOVE_BACK, MOVE_LEFT, MOVE_RIGHT, ROTATE_LEFT, ROTATE_RIGHT, MOVE_ARM_HEIGHT_P, MOVE_ARM_HEIGHT_M, MOVE_ARM_X_P, MOVE_ARM_X_M, MOVE_ARM_Y_P, MOVE_ARM_Y_M, MOVE_ARM_Z_P, MOVE_ARM_Z_M, PICKUP, DONE, MOVE_WRIST_P, MOVE_WRIST_M, GRASP_O, GRASP_C, LOOK_UP, LOOK_DOWN]
