...
class DiverseBringObjectTaskSamplerReplay(DiverseBringObjectTaskSampler):
    ...
    def next_task(
        ...
        task = self.test_tasks[self.pointer]
        self.pointer += 1
        ...
        scene_name = task['task_info']['goal_location']["scene_name"]
        init_object = task['task_info']['init_location']
        goal_object = task['task_info']['goal_location']

        agent_state = task['task_info']["agent_initial_state"]
        list_of_taken_actions = task['task_info']['full_action_list']
        ...
        task_info = {
            ...
            # 'goal_object_query_file_name' : goal_img_adr,
            'episode_number': random.uniform(0, 10000),
            'list_of_taken_actions': list_of_taken_actions
        }
